...
gcloud container clusters create $CLUSTER --zone $ZONE --scopes $SCOPE --enable-autoscaling --min-nodes "100" --max-nodes "100" --machine-type=n1-highmem-4 --scopes=logging-write,cloud-platform --addons HorizontalPodAutoscaling,HttpLoadBalancing
